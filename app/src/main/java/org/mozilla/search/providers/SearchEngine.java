...
public abstract class SearchEngine {
     ...
     * external browser. As a general rule, keep the users
     * as long as they're in the search engine, and have
     * them exit when they click on a search result.
     */
    final public boolean isExitUrl(String url) {
     ...
     */
    final public String getSuggestionTemplate() {
        if (suggestionTemplate == null) {
            suggestionTemplate = suggestUriForQuery("__searchTerms__");
        }
